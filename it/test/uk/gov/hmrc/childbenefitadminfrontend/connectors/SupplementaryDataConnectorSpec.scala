...
import uk.gov.hmrc.childbenefitadminfrontend.models.{DailySummary, DailySummaryResponse, ListResult, Metadata, ObjectSummary, SubmissionItem, SubmissionItemStatus, SubmissionSummary}
import uk.gov.hmrc.childbenefitadminfrontend.utils.WireMockHelper
...
class SupplementaryDataConnectorSpec
  ...
  private lazy val app: Application =
    GuiceApplicationBuilder()
      .configure("microservice.services.child-benefit-service.port" -> server.port())
      .build()
  ...
  "get" - {
    ...
    val id = "id"
    val url = s"/child-benefit-service/supplementary-data/$id"
  ...
  "list" - {
    ...
    val hc = HeaderCarrier()
    val url = s"/child-benefit-service/supplementary-data"
  ...
  "dailySummaries" - {
    ...
    val hc = HeaderCarrier()
    val url = s"/child-benefit-service/supplementary-data/summaries"
  ...
  "retry" - {
    ...
    val hc = HeaderCarrier()
    val id = "id"
    val url = s"/child-benefit-service/supplementary-data/$id/retry"
